"""
Django settings for legal_manager project.
"""
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@legalsystem.com')

# LLM Configuration
LLM_API_KEY = config('LLM_API_KEY', default='')
LLM_API_ENDPOINT = config('LLM_API_ENDPOINT', default='https://api.openai.com/v1/chat/completions')
