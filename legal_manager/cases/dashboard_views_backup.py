# dashboard_views.py - Professional Dashboard për Legal Case Manager
...
class DashboardView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Common data për të gjitha roles
        context.update({
            'user': user,
            'today': today,
    ...
    def get_admin_dashboard_data(self, today, week_ago, month_ago, year_ago):
        ...
        total_invoices = Invoice.objects.aggregate(
            ...
            paid=Sum('total_amount', filter=Q(paid=True)),
            unpaid=Sum('total_amount', filter=Q(paid=False))
        )
